...
//Script per la fire ball della Kitsune
public class FireballKitsune : MonoBehaviour
{
    #region Variables
    ...
    public void Init(Transform enemyTransform, float d, EnemyBase enemy)
    {
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (enemy == null || enemy != actualTarget || !enemy.GetActive())
            return;
