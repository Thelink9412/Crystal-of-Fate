...
//Script per gestire il proiettile lanciato da un Satyr
public class ProjectileSatyr : MonoBehaviour
{
    #region Variables
    ...
    public void Init(Vector3 targetPosition, float d, Satyr satyr)
    {
        PlayerBase player = satyr.GetComponent<PlayerBase>();
